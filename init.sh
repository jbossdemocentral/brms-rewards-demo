...
echo "  - enabling demo users and configuration for human tasks in jbpm-human-task.war web.xml file..."
echo
...
echo 
cp $PRJ_DIR/target/jboss-brms-rewards-model.jar $SERVER_DIR/business-central-server.war/WEB-INF/lib
